...
export default function Branding() {
  ...
  return (
    <section
      ref={sectionRef}
      id="eventos"
      className="relative scroll-mt-28 overflow-hidden bg-[#FCE8EC] py-16 md:py-10"
    >
      <div className="mx-auto max-w-[1600px] px-6 md:px-10">
        <article className="relative min-h-[50vh]">
          <div className="relative z-10">
            <div className="branding-line-1 flex flex-wrap items-start gap-x-4 gap-y-2 font-anton uppercase leading-[0.84] tracking-[-0.05em] text-[clamp(4rem,12vw,9rem)]">
              <span className="text-[#F25394]">Levamos</span>
              <span className="text-[#97263C]">Sabor</span>
            </div>

            <div className="branding-line-2 flex flex-wrap items-start justify-start md:justify-center gap-x-4 gap-y-2 mt-2 md:mt-4 font-anton uppercase leading-[0.84] tracking-[-0.05em] text-[clamp(4rem,12vw,9rem)]">
          ...
          <div className="pointer-events-none absolute inset-0 z-0">
            ...
            <span className="floating-word floating-3 absolute -left-[10%] tracking-wider  top-[30%] font-anton uppercase leading-none tracking-[-0.05em] text-[clamp(2.4rem,6vw,5.5rem)] text-[#F25394]/10">
              sabor
            </span>
            ...
            <span className="floating-word floating-5 tracking-wider  absolute left-[48%] top-[62%] font-anton uppercase leading-none tracking-[-0.05em] text-[clamp(2rem,5vw,4rem)] text-[#97263C]/18">
              exclusivo
            </span> */}
